...
title('ROC CURVE UNDER Rayleigh and Nakagami Channel');
legend('rayleigh for snr= -6db','nakagami for snr = -6db', 'rayleigh for snr= 0db ', 'nakagami for snr= 0 db', 'rayleigh for snr= 2db','nakagami for snr= 2db');